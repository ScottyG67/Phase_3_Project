...
user1 = User.create(username: "Mars", apod: true, weather: true, nasaimage: true, userimage: true)
user2 = User.create(username: "Nebula", apod: true, weather: false, nasaimage: true, userimage: true)
user3 = User.create(username: "Earth", apod: true, weather: false, nasaimage: true, userimage: true)
